        ...
        <form onSubmit={handleCalculate} className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="number" value={interObt} onChange={(e) => setInterObt(e.target.value)} placeholder="e.g. 900" className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-amber-600 transition" required />
            </div>
            <div>
          ...
          <button type="submit" className="w-full mt-2 py-3 px-4 bg-amber-600 hover:bg-amber-700 text-white font-bold rounded-xl shadow-md transition flex items-center justify-center gap-2">
            <Calculator className="w-5 h-5" /> Calculate FAST Aggregate
          </button>
        </form>
